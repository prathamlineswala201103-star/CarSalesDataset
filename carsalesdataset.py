...
st.sidebar.markdown("**Data requirements**")
st.sidebar.markdown(
    """
    Upload a CSV with columns similar to the sample dataset:
    - Manufacturer
    - Model
    - Sales in thousands
    - Vehicle type
    ...
    - Fuel capacity
    - Fuel efficiency
    - Latest Launch (date, e.g. 23-Apr-14)

    The closer your CSV schema is to this structure,
    the more accurate and complete the visuals will be.
    """
)
...
# ---------- HEADER ----------
st.markdown("## Car Sales – Executive Analytics Dashboard")
st.caption(
    "Upload any car sales CSV with a schema similar to the sample Car_sales.csv "
    "to get the same style of filters, KPIs and charts."
)
